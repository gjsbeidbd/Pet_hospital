...
import { getMyDoctorSchedules } from '@/services/api'
...
const getCurrentDoctorFromStorage = () => {
...
const fetchMySchedule = async () => {
  if (!currentDoctor.value || !currentDoctor.value.id) {
  ...
  try {
    ...
    const res = await getMyDoctorSchedules(currentDoctor.value.id, startDate, endDate)
