<template>
  ...
  >
    ...
    <div v-if="activeMenu === '2'">
      <MyPets 
        :breed-options-map="breedOptionsMap" />
    </div>
...
const breedOptionsMap = {
  '狗': [
    '金毛寻回犬', '泰迪/贵宾犬', '柴犬', '柯基', '拉布拉多',
    '哈士奇', '萨摩耶', '阿拉斯加雪橇犬', '边境牧羊犬', '德国牧羊犬',
    '比格犬', '斗牛犬', '吉娃娃', '博美犬', '约克夏梗',
    '法国斗牛犬', '英国斗牛犬', '松狮犬', '藏獒', '中华田园犬'
  ],
  '猫': [
    '英短蓝猫', '布偶猫', '暹罗猫', '加菲猫', '中华田园猫',
    '美国短毛猫', '波斯猫', '缅因猫', '挪威森林猫', '俄罗斯蓝猫',
    '苏格兰折耳猫', '英国短毛猫', '孟加拉豹猫', '埃及猫', '阿比西尼亚猫',
    '东方短毛猫', '喜马拉雅猫', '土耳其安哥拉猫', '日本短尾猫', '新加坡猫'
  ],
  '其他': [
    '兔子', '仓鼠', '鸟类'
  ]
